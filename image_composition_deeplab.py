...
class ImageComposition():
    ...
    def _validate_and_process_args(self, args):
        ...
        self.backgrounds_dir = Path(args.background_dir)
        ...
        for super_category in list(self.foregrounds_dict.keys()):
            ...
            for j, category in enumerate(list(self.foregrounds_dict[super_category].keys())):
                ...
                for i, foreground_path in enumerate(tqdm(self.foregrounds_dict[super_category][category])):
                    ...
                    index_category = list(self.foregrounds_dict[super_category]).index(category)  # added by me

                    foregrounds = [{
                            'super_category': super_category,
                            'category': category,
                            'index_category': index_category,  # added by me
    ...
    def _compose_images(self, foregrounds, background_path):
        ...
        for fg in foregrounds:
            ...
            # fg_image = self._transform_foreground(fg, fg_path)  # removed by me
            fg_image = Image.open(fg_path)  # added by me
            ...
            ########## added by me ##########################
            index_category = fg['index_category'] + 1  # added by me
            red_channel = uint8_mask * index_category
            green_channel = uint8_mask * index_category
            blue_channel = uint8_mask * index_category
            ################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, dest="input_dir", required=True, help="The input directory. \
                        This contains  a 'foregrounds' directory which \
    ...
    parser.add_argument("--background_dir", type=str, required=True, dest="background_dir", help="Contains images for \
